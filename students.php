        ...
        <main>
            <section>
                <div class="sidebar">
                    <nav> 
                        <menu>
                            <p class="scroll-to" class="no-bottom-padding">Student Information</p>
                            <p class="scroll-to">Academic Information</p>
                            <p class="scroll-to">Administrative Support</p>
                            <p class="scroll-to">Student Services</p>
                            <p class="scroll-to">University Services</p>
                            <p class="scroll-to">Life at University</p>
                            <p class="scroll-to">Communications</p>
                            <p class="scroll-to">Learning Resources</p>
                        </menu>
                    </nav>
                </div>
                <div class="info">
                    ...
                    <div class="text-left">
                        ...
                        <ul>
                            ...
                            <li>Library and Learning Resource Services - Information on LLRS services, access to the on-line catalogue, links to external academic resources and guides 
                        ...
                        <h2 id="Administrative Support">Administrative Support</h2>
                        <ul>
                        ...
                        <h2 id="University Services">University Services</h2>
                        <ul>
                        ...
                        <h2 id="Life at University">Life at University</h2>
                        <ul>
